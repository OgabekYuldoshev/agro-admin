    ...
    return (
        <Modal title="Yangi mahsulot qo'shish!" visible={open} onCancel={onClose} footer={null} width={1000}>
            <Form
                ...
                >
                    <Upload className="w-full" beforeUpload={() => Upload.LIST_IGNORE} name="image" accept=".img, .jpg, .jpeg" maxCount={3}>
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: 'Please input your category!' }]}
                >
                    <Select onChange={handleSubCategory} onFocus={() => dispatch(getCategory())} placeholder='Tanlang....'>
                        {
